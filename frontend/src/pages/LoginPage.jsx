  ...
  return (
    <div className="hidden lg:flex flex-col items-center justify-center w-1/2 p-8 relative overflow-hidden bg-gradient-to-br from-emerald-600 via-emerald-500 to-emerald-700">
      ...
      <div ref={visualRef} className="text-center text-white z-10">
        <div className="mb-8">
          <div className="w-52 h-24 m-auto mb-6 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
           
          <img src={assets.logo} alt=""  className="w-200"/>
          </div>
        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-12 flex flex-col justify-center">
          ...
          <form ref={formRef} onSubmit={handleFormSubmit} className="space-y-6">
            {loginMethod === "email" ? (
              ...
              <div className="space-y-4">
                <div className="relative">
                  <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 w-5 h-5 pointer-events-none" />
                  <input
                    ref={(el) => (inputRefs.current[0] = el)}
                    type="tel"
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300"
                  >
                    Send OTP
                  </button>
                </div>
